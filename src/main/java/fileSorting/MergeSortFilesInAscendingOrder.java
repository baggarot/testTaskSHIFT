...
@NoArgsConstructor
public class MergeSortFilesInAscendingOrder {

    private int positionA = 0;
    private int positionB = 0;

    public void writingToFile(String files, String files1, String files2) {
        try (FileWriter writer = new FileWriter(files)) {
            ReadingAFile file = new ReadingAFile();
            int[] array = mergeSortAscending(Objects.requireNonNull(file.readingAFileFromIntegers(files1)),
    ...
    public void writingLinesToAFile(String file, String file1, String file2) {
        try (FileWriter writer = new FileWriter(file)) {
            ...
            String[] array = mergeSortAscendingRows(readingAFile.readingAFileFromLines(file1),
    ...
    private int[] mergeSortAscending(int[] arrayA, int[] arrayB) {
    ...
    private String[] mergeSortAscendingRows(String[] arrayA, String[] arrayB) {
